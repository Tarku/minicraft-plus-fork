...
public class InputHandler implements KeyListener {
	...
	*/
	...
	private void initKeyMap() {
		...
		keymap.put("BEDTPCHEAT", "O"); // Toggle potion effect display
		keymap.put("STAIRSDOWNCHEAT", "M"); // Toggle potion effect display
		keymap.put("STAIRSUPCHEAT", "K"); // Toggle potion effect display
