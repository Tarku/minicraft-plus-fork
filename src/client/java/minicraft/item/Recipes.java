...
public class Recipes {
	...
	public static ArrayList<Recipe> anvilRecipes = new ArrayList<>();
	public static ArrayList<Recipe> ovenRecipes = new ArrayList<>();
	public static ArrayList<Recipe> furnaceRecipes = new ArrayList<>();
	public static ArrayList<Recipe> workbenchRecipes = new ArrayList<>();
	public static ArrayList<Recipe> enchantRecipes = new ArrayList<>();
	public static ArrayList<Recipe> craftRecipes = new ArrayList<>();
	public static ArrayList<Recipe> loomRecipes = new ArrayList<>();
	...
	public static void initRecipes() {
		...
		furnaceRecipes.add(new Recipe("Coal_1", "Wood_10"));
